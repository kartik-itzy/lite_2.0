...
@Component({
  ...
  template: `
    <div class="p-6 space-y-6">
      <!-- Header -->
      <div class="mb-8">
        <h1 class="text-2xl font-bold text-gray-900 mb-2">Component Library Demo</h1>
        ...
        <app-card class="mb-8" [header]="true" [footer]="true">
          ...
          <div class="space-y-8">
            <!-- Greeting Card -->
            <div>
              <h3 class="text-sm font-semibold text-gray-900 mb-4">Greeting Card</h3>
            ...
            <!-- Stat Cards -->
            <div>
              <h3 class="text-sm font-semibold text-gray-900 mb-4">Stat Cards</h3>
            ...
            <!-- Chart Cards -->
            <div>
              <h3 class="text-sm font-semibold text-gray-900 mb-4">Chart Cards</h3>
              <div class="grid grid-cols-1 lg:grid-cols-2 gap-4">
            ...
            <!-- Progress Cards -->
            <div>
              <h3 class="text-sm font-semibold text-gray-900 mb-4">Progress Cards</h3>
              <div class="grid grid-cols-1 lg:grid-cols-2 gap-4">
            ...
            <!-- List Cards -->
            <div>
              <h3 class="text-sm font-semibold text-gray-900 mb-4">List Cards</h3>
              <div class="grid grid-cols-1 lg:grid-cols-2 gap-4">
            ...
            <!-- Metric Cards -->
            <div>
              <h3 class="text-sm font-semibold text-gray-900 mb-4">Metric Cards</h3>
        ...
        <app-card class="mb-8" [header]="true" [footer]="true">
          ...
          <div class="space-y-6">
            <!-- Button Variants -->
            <div>
              <h3 class="text-sm font-semibold text-gray-900 mb-3">Variants</h3>
            ...
            <!-- Button Sizes -->
            <div>
              <h3 class="text-sm font-semibold text-gray-900 mb-3">Sizes</h3>
            ...
            <!-- Button States -->
            <div>
              <h3 class="text-sm font-semibold text-gray-900 mb-3">States</h3>
              <div class="flex flex-wrap gap-3">
        ...
        <app-card class="mb-8" [header]="true" [footer]="true">
          ...
          <div class="space-y-6">
            <!-- Input Types -->
            <div>
              <h3 class="text-sm font-semibold text-gray-900 mb-3">Types</h3>
        ...
        <app-card class="mb-8" [header]="true" [footer]="true">
          ...
          <div class="space-y-6">
            ...
            <!-- Badge Styles -->
            <div>
              <h3 class="text-sm font-semibold text-gray-900 mb-3">Styles</h3>
              <div class="flex flex-wrap gap-2">
        ...
        <app-card class="mb-8" [header]="true" [footer]="true">
          ...
          <div class="space-y-6">
            ...
            <!-- Loading with Text -->
            <div>
              <h3 class="text-sm font-semibold text-gray-900 mb-3">With Text</h3>
        ...
        <app-card class="mb-8" [header]="true" [footer]="true">
          ...
          <form [formGroup]="demoForm" (ngSubmit)="onSubmit()" class="space-y-4">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
              <app-input
